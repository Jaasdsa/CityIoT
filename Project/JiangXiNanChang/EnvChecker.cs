...
namespace JiangXiNanChang
{
    class EnvChecker
    {
        ...
        public static bool Check(out string errMsg)
        {
            ...
            // 综合测点
            Config.CeDianParam = new CityWEBDataService.PandaParam();
            Config.CeDianParam.appKey = Config.pumpParam.appKey;
            Config.CeDianParam.appSecret = Config.pumpParam.appSecret;
            Config.CeDianParam.getTokenUrl = Config.pumpParam.getTokenUrl;
            Config.CeDianParam.getDataUrl = @"https://new.s-water.cn/App/GetZHData";
            Config.CeDianParam.useName = Config.pumpParam.useName;
            Config.CeDianParam.saveInterVal = Config.pumpParam.saveInterVal;
            if (!Config.CeDianParam.Check(out errMsg))
                return false;
