   ...
   public class WEBPandaYLSacdaService : ISonService, IServiceWorker
    {
        ...
        public WEBPandaYLSacdaService(ConfSonWebPandaYLDataService pandaYaLiParam)
        {
            Config.pandaYaLiParam = pandaYaLiParam;
        }
        ...
        public void Start(out string errMsg)
        {
            ...
            this.param =ToPandaParam(Config.pandaYaLiParam);
        ...
        // 配置对象转化
        private PandaParam ToPandaParam(ConfSonWebPandaYLDataService param)
        {
