   ...
   public class WEBPandaZHCDSacdaService : ISonService, IServiceWorker
    {
        ...
        public WEBPandaZHCDSacdaService(ConfSonWebPandaZHCDDataService pandaCeDianParam) 
        {
            Config.pandaCeDianParam = pandaCeDianParam;
        }
        ...
        public void Start(out string errMsg)
        {
            ...
            this.param = ToPandaParam(Config.pandaCeDianParam);
        ...
        // 配置对象转化
        private PandaParam ToPandaParam(ConfSonWebPandaZHCDDataService param)
        {
